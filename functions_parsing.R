...
domain = function(x) {
  if (str_detect(x, '^htt.*://(twitter.com/|www.facebook.com/|www.instagram.com/|vk.com/|youtube.com/).*')){
    extr = str_extract(x, '(twitter.com/|www.facebook.com/|www.instagram.com/|vk.com/|youtube.com/).*?($|/)')[[1]]
